...
const forms = document.querySelectorAll('form');
    ...
    console.log('gdegfger');
});

///Tegs
//f
//Тригеры - это елементы которые вызывают последующие действия

// если какой-то участок кода начинает повторяться то его стоит вынести в отдельную функцию



// function showModalByScroll(){
   //       if(window.pageYOffset + document.documentElement.clientHeight >= document.
   // documentElement.scrollHeight -1){ -1 это до того как мы долестаем до конца будет юзаться окно     
   //        }
   // Это вариант если какие-то технические ограничение браузера или монитора